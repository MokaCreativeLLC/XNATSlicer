...
class TreeView(View, qt.QTreeWidget):
    """ 
    TreeView is a subclass of both the View class and the
    ...
    def setup(self):
        ...
        savedFontSize = self.MODULE.SettingsFile.getSetting(xnatHost, self.MODULE.TreeViewSettings.FONT_SIZE_TAG)
    ...
    def makeTreeItems(self, parentItem = None, children = [],  metadata = {}, expandible = None):
        ...
        #------------------------
        if str(parentItem.__class__) == "<class 'TreeView.TreeView'>":
