...
class NodeDetails(qt.QWidget):
    ...
    def __init__(self, MODULE = None):
        ...
        self.textEdit.setStyleSheet('border: none; padding:' + 
        ...
        print "NEED TO SET NODE DETAILS FONT CALLBACK"
        return
        ...
        #--------------------
        storedFontSetting = \
                    self.MODULE.SettingsFile.\
                    getSetting(self.MODULE.LoginMenu.hostDropdown.currentText,
                    self.MODULE.Settings['DETAILS'].FONT_SIZE_TAG)
        storedFont = int(storedFontSetting[0]) if \
                     len(storedFontSetting) > 0 else XnatSlicerGlobals.FONT_SIZE
    ...
    def setXnatNodeText(self, detailsDict):
        ...
        metadataTag = \
            self.MODULE.Settings['DETAILS'].metadataToSetting['main'] + \
