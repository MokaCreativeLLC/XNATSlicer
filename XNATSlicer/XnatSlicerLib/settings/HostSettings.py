...
class HostSettings(Settings):
    """ 
    HostSettings is the Settings pertaining to
    ...
    def __init__(self, title, MODULE):
        ...
        # Call parent init
        #--------------------
        super(HostSettings, self).__init__(title, MODULE)
    ...
    def setButtonStates(self, hostName):   
        ...
        """
        ##print hostName, self.MODULE.SettingsFile.isModifiable(hostName) 
        if self.MODULE.SettingsFile.isModifiable(hostName):
    ...
    def writeHost(self):
        ...
        #--------------------
        self.MODULE.SettingsFile.saveHost(self.nameLine.text, 
                                              self.urlLine.text, 
