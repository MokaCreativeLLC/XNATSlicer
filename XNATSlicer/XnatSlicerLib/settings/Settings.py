...
class Settings(qt.QScrollArea):
    ...
    TreeViewSettings, DetailsSettings, MetadataSettings,
    ...
    (especially MetadataSettings objects).
    ...
    def createMetadataManagers(self, *args):
        """ Creates any number of metadata managers as 
            ...
            the MetadataManagers dictionary.
        """
        for arg in args:
            self.MetadataManagers[arg] = MetadataManager(self.MODULE)
            ...
            self.MetadataManagers[arg].setOnMetadataCheckedTag(self.ON_METADATA_CHECKED_TAGS[arg])
    ...
    def setDefaultSelectedMetadata(self, label, *args):
        ...
        #--------------------
        xnatHosts = [self.MODULE.LoginMenu.hostDropdown.itemText(ind) for ind in range(0, self.MODULE.LoginMenu.hostDropdown.count)]
        for xnatHost in xnatHosts:
            ...
            for xnatLevel in XnatGlobals.DEFAULT_XNAT_LEVELS:
                ...
                for key in self.ON_METADATA_CHECKED_TAGS:
                    ...
                    savedMetadataItems = self.MODULE.SettingsFile.getSetting(xnatHost, levelTag)
