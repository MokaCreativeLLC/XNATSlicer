...
class LoadWorkflow(object):
    """ 
    LoadWorkflow is effectively a factory for various loader classes.  
    Loader types are determined by the View item being clicked in the 
    LoadWorkflow function 'beginWorkflow'.  
    ...
    def beginWorkflow(self, src = None):
        """ This function is the first to be called
            ...
            LoadWorkflow) will be called on in this function.
        """
        ...
        # Show clearSceneDialog
        #------------------------
        if not XnatSlicerUtils.isCurrSceneEmpty() and not self.skipEmptySceneCheck:
