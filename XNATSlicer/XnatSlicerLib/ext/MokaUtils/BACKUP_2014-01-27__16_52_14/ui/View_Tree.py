...
class View_Tree(View, qt.QTreeWidget):
    ...
    def setup(self):
        ...
        savedFontSize = self.MODULE.SettingsFile.getSetting(xnatHost, self.MODULE.Settings['TREEVIEW'].FONT_SIZE_TAG)
    ...
    def populateColumns(self, widgetItem = None, xnatMetadata = None):
        ...
        infoMetadata = self.MODULE.SettingsFile.getSetting(xnatHost, 
                                                           self.MODULE.Settings['TREEVIEW'].metadataToSetting['info'] 
    ...
    def sort_accessed(self):
        ...
        #self.MODULE.Settings['TREEVIEW'].setButtonDown(category = 'sort' , name = 'accessed', isDown = True, callSignals = False)
    ...
    def loadProjects(self, filters = None, projectContents = None):
        ...
        # If no 'filters'...
        #----------------------
        defaultFilterButton = None #self.MODULE.Settings['TREEVIEW'].buttons['sort']['accessed']
    ...
    def getXnatUriObject(self, item):    
        ...
        #------------------------
        pathObj['pathDict'] = XnatSlicerUtils.getXnatPathDict(pathObj['currUri'])
    ...
    def isDICOMFolder(self, item):  
        ...
        for x in range(0, item.childCount()):          
            try:
                ...
                if XnatSlicerUtils.isDICOM(child.text(self.columns['MERGED_LABEL']['location'])):
                    #print "found dicom"
                    dicomCount +=1
            except Exception, e:
                #print str(e)
